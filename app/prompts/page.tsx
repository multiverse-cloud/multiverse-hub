...
export const metadata: Metadata = {
  title: 'Prompt Hub - Premium AI Prompts for ChatGPT, Claude, Images, and Editing',
  description:
...
export default async function PromptsPage({ searchParams }: PromptsPageProps) {
  ...
  const activeCategory = resolvePromptCategory(normalizePromptSearchParam(resolvedSearchParams?.category))
  const activeModel = resolvePromptModel(normalizePromptSearchParam(resolvedSearchParams?.model))
  ...
  return (
    <PublicLayout>
      <UniverseTopBar items={[{ label: 'Home', href: '/' }, { label: 'Prompts' }]} actionName="Prompt Hub" actionSlug="prompts" />
      <PromptHubPage
