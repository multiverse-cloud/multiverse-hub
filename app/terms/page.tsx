  ...
  const sections = [
    {
      ...
      content: 'By accessing or using Multiverse Tools ("the Service"), you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, please do not use the Service. These terms apply to all visitors, users, and anyone who accesses the Service.',
    },
    {
      title: 'Use of Service',
      content: 'Multiverse Tools grants you a personal, non-exclusive, non-transferable, revocable licence to use the Service for lawful purposes. You may use the tools for personal or commercial projects without restriction, as long as your use complies with these terms and applicable law. We reserve the right to modify, suspend, or discontinue any part of the Service at any time without notice.',
    },
    {
      title: 'Intellectual Property',
      content: 'The Multiverse Tools name, logo, design, and all original content on this platform are owned by or licenced to Multiverse Tools. You retain full ownership of any files you upload or content you create using the Service. We make no claim over your files or output. Open-source libraries used by the Service are subject to their respective licences.',
    },
    {
