        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <h2 className="text-2xl font-bold md:text-3xl">Fresh from the workshop</h2>
            </div>
            ...
            {NEW_TOOLS.map((tool, index) => {
              ...
              return (
                <Link
                  ...
                  className="group flex items-start gap-4 rounded-2xl border border-border bg-card p-5 transition-all duration-300 hover:-translate-y-1 hover:border-slate-300 hover:shadow-lg hover:shadow-slate-900/5 dark:hover:border-slate-700 animate-fade-in"
                  style={{ animationDelay: `${index * 0.06}s`, animationFillMode: 'both' }}
                >
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-slate-100 transition-all duration-300 group-hover:bg-slate-900 group-hover:scale-105 dark:bg-slate-800 dark:group-hover:bg-slate-100">
