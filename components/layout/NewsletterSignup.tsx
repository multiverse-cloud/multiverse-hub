...
export default function NewsletterSignup() {
  ...
  return (
    <div className="mx-auto max-w-md">
      <form onSubmit={handleSubmit} className="premium-input-shell flex gap-3" aria-label="Newsletter signup">
        <input
          type="email"
          inputMode="email"
          autoComplete="email"
        ...
        <button
          ...
          className="inline-flex items-center gap-2 whitespace-nowrap rounded-2xl bg-indigo-600 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-70"
        >
