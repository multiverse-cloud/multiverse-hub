import { ClipboardPaste, Link2, Loader2, Zap } from 'lucide-react'
...
export default function DownloaderInputBar({
  ...
  return (
    <div
      className={cn(
        'rounded-[18px] border p-2 shadow-[0_20px_40px_-30px_rgba(15,23,42,0.18)]',
        isInverse
    ...
    >
      <div className="flex flex-col gap-2 md:flex-row md:items-center">
        <div className="flex min-h-[70px] flex-1 items-center gap-3 rounded-[14px] px-4">
          ...
          <input
            ...
            className={cn(
              'w-full border-none bg-transparent py-4 text-sm font-medium outline-none',
              isInverse
        ...
        <div className="flex gap-2 p-1">
          ...
          <button
            ...
            className={cn(
              'inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-3 text-sm font-semibold transition-all disabled:cursor-not-allowed disabled:opacity-60',
              isInverse
