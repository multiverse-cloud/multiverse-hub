    ...
    <div className="group grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 rounded-xl bg-white p-3 ring-1 ring-slate-200/80 transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_28px_-24px_rgba(15,23,42,0.42)] motion-reduce:hover:translate-y-0 motion-reduce:transition-none dark:bg-slate-950/70 dark:ring-slate-800 sm:p-3.5">
      ...
      <div className="min-w-0">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <span className={cn("hidden rounded-full px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-[0.1em] sm:inline-flex", styles.pill)}>
            {option.ext}
          </span>
        </div>
    ...
    <section className="space-y-2.5">
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0">
          ...
          <p className="hidden text-xs font-normal text-slate-500 dark:text-slate-400 sm:block">{subtitle}</p>
        </div>
      </div>
          ...
          <article className="rounded-xl bg-slate-50 p-3 ring-1 ring-slate-200/70 dark:bg-slate-900/55 dark:ring-slate-800 sm:p-4">
            <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_180px] sm:items-center">
              <div className="min-w-0 space-y-3">
                <div className="inline-flex items-center gap-1.5 rounded-full bg-white px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-600 ring-1 ring-slate-200/80 dark:bg-slate-950 dark:text-slate-300 dark:ring-slate-800">
                  <BadgeCheck className="h-3.5 w-3.5 text-emerald-600" aria-hidden="true" />
                  {info.platform}
                </div>
                <div>
                  <h2 className="line-clamp-2 text-base font-semibold leading-snug tracking-tight text-slate-950 dark:text-white sm:text-xl">
                    {info.title}
                  </h2>
            ...
            <aside className="rounded-xl bg-slate-50 p-3 ring-1 ring-slate-200/70 dark:bg-slate-900/55 dark:ring-slate-800">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-slate-950 dark:text-slate-50">Thumbnail</h3>
                    <p className="text-xs font-normal text-slate-500 dark:text-slate-400">HD cover image</p>
                  </div>
                </div>
                {primaryThumbnail ? (
                  <DownloadActionButton
