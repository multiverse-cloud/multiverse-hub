...
export const TRAFFIC_SEO_LANDING_PAGES: SeoLandingPageData[] = [
  ...
  toolPage({
    ...
    h1: 'Compress image to 50KB online for free',
    toolName: 'Compress Image',
    toolHref: '/tools/image/compress-image',
    categoryHref: '/tools/image',
    job: 'Reduce photos and screenshots to around 50KB for application forms, profile uploads, email attachments, and lightweight web use.',
    keywords: ['compress image to 50KB', 'compress photo to 50KB', 'image compressor 50KB', 'reduce image size to 50KB'],
  }),
  toolPage({
    ...
    toolHref: '/tools/image/compress-image',
    categoryHref: '/tools/image',
    job: 'Make large JPG, PNG, or WebP files smaller for forms, website uploads, documents, and sharing while keeping a practical preview quality.',
    keywords: ['compress image to 200KB', 'compress photo to 200KB', 'image compressor 200KB', 'reduce image size to 200KB'],
  }),
  toolPage({
  ...
  toolPage({
    ...
    toolHref: '/tools/image/convert-image',
    categoryHref: '/tools/image',
    job: 'Convert JPG photos into PNG files for design uploads, transparent workflows, documentation, and image editing pipelines.',
    keywords: ['JPG to PNG', 'convert JPG to PNG', 'JPG PNG converter', 'free image converter'],
  }),
  toolPage({
    slug: 'png-to-jpg',
    title: 'PNG to JPG Converter',
    h1: 'Convert PNG to JPG online for smaller files',
    toolName: 'Convert Image',
    toolHref: '/tools/image/convert-image',
    categoryHref: '/tools/image',
    job: 'Convert PNG images into JPG files when you need smaller photo-style uploads for forms, email, websites, or social sharing.',
    keywords: ['PNG to JPG', 'convert PNG to JPG', 'PNG JPG converter', 'free PNG to JPG converter'],
  }),
  toolPage({
  ...
  toolPage({
    ...
    toolHref: '/tools/image/remove-background',
    categoryHref: '/tools/image',
    job: 'Remove or clean up image backgrounds for product photos, profile pictures, thumbnails, marketplace listings, and design assets.',
    keywords: ['remove image background', 'background remover', 'remove background online', 'free background remover'],
  }),
  toolPage({
    slug: 'image-to-pdf',
    ...
    toolHref: '/tools/image/image-to-pdf',
    categoryHref: '/tools/image',
    job: 'Turn JPG, PNG, and WebP images into PDF files for forms, receipts, scanned pages, notes, and document sharing.',
    keywords: ['image to PDF', 'JPG to PDF', 'convert image to PDF', 'free image to PDF converter'],
  }),
  toolPage({
    slug: 'pdf-to-jpg',
    ...
    job: 'Convert PDF pages into JPG images for previews, sharing, thumbnails, documentation, and quick visual extraction.',
    keywords: ['PDF to JPG', 'convert PDF to JPG', 'PDF JPG converter', 'free PDF to image converter'],
  }),
  toolPage({
  ...
  toolPage({
    ...
    h1: 'JSON validator and formatter online',
    toolName: 'JSON Formatter',
    toolHref: '/tools/dev/json-formatter',
    categoryHref: '/tools/dev',
    job: 'Validate JSON syntax, format messy API responses, and make configuration data easier to inspect while debugging.',
    keywords: ['JSON validator', 'validate JSON online', 'JSON checker', 'JSON formatter validator'],
  }),
  toolPage({
    slug: 'timestamp-converter',
    title: 'Timestamp Converter',
    h1: 'Timestamp converter for Unix and ISO dates',
    toolName: 'Timestamp Converter',
    toolHref: '/tools/dev/timestamp-converter',
    categoryHref: '/tools/dev',
    job: 'Convert Unix timestamps, milliseconds, ISO dates, local time, and readable dates for logs, APIs, analytics, and debugging.',
    keywords: ['timestamp converter', 'Unix timestamp converter', 'epoch converter', 'convert timestamp online'],
  }),
  toolPage({
    slug: 'free-qr-code-generator',
    title: 'Free QR Code Generator',
    h1: 'Free QR code generator for links and text',
    toolName: 'QR Code Generator',
    toolHref: '/tools/image/qr-code-generator',
    categoryHref: '/tools/image',
    job: 'Create QR codes for URLs, text, contact details, campaigns, menus, documents, and quick sharing from a mobile-friendly page.',
    keywords: ['free QR code generator', 'QR code generator', 'QR code maker', 'create QR code online'],
  }),
  toolPage({
