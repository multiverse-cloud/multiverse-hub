...
function normalizeTemplateEntry(template: TemplateEntry): TemplateEntry {
  ...
  return {
    ...
    cloudinaryPublicId: asString((template as TemplateEntry & { cloudinaryPublicId?: unknown }).cloudinaryPublicId) || undefined,
    ...
    vercelDeployUrl: asString((template as TemplateEntry & { vercelDeployUrl?: unknown }).vercelDeployUrl) || undefined,
    githubUrl: asString((template as TemplateEntry & { githubUrl?: unknown }).githubUrl) || undefined,
